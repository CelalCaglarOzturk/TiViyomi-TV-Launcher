 ...
 * when a directional key is held down on an Android TV remote.
 * Consumes rapid repeats and manually moves focus at a controlled rate.
 *
 * @param horizontalGateMs minimum interval between horizontal repeats (default 80ms)
 * @param verticalGateMs   minimum interval between vertical repeats (default 112ms)
 */
